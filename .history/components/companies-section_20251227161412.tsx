        ...
        >
          {marqueeCompanies.map((company, index) => (
            <div
              ...
              className="mx-12 flex flex-col items-center justify-center  grayscale md:grayscale md:opacity-60 md:hover:opacity-100 md:hover:grayscale-0 transition-all duration-300 opacity-100 md:opacity-60 md:hover:opacity-100"
            >
              {/* Logo */}
