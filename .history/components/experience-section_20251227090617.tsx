...
export default function ExperienceSection() {
  ...
  const { experiences, loading, error } = useGetExperience();
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        {loading ? (
          <div className="animate-pulse text-xl text-gray-500 text-center py-20">
            Loading experiences...
          </div>
        ) : error ? (
          <div className="text-xl text-red-500 text-center py-20">
            Error: {error}
          </div>
        ) : (
          <motion.div
